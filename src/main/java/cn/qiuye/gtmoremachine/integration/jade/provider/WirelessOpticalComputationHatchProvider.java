...
public class WirelessOpticalComputationHatchProvider extends CapabilityBlockProvider<IGTMMJadeIF> {
    ...
    @GTMMRegisterLanguage(valuePrefix = GTJadePlugin.JADE_PREFIX, en = "[GTMoreMachine] Wireless OpticalComputation", cn = "[GTMoreMachine] 无线光学算力仓")
    public static final String WIRELESS_OPTICAL_COMPUTATION_HATCH_PROVIDER = "wireless_optical_computation_hatch_provider";
