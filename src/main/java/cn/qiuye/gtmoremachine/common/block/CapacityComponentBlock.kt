...
class CapacityComponentBlock(properties: Properties, @field:Getter val data: ICapacityComponentData) :
    Block(properties) {
    ...
    enum class CapacityComponentBlockPartType :
        StringRepresentable,
        ...
        override fun getCapacityComponentName(): String = name.lowercase()

        override fun getSerializedName(): String = capacityComponentName
    }
}
