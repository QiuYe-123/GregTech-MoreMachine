    ...
    public InteractionResult onItemUseFirst(ItemStack stack, UseOnContext context) {
        ...
        if (GTMMConfig.getINSTANCE().isWirelessRateEnable) {
            ...
            if (rate > 0) {
                ...
                context.getPlayer().sendSystemMessage(Component.translatable("item.gtmoremachine.wireless_transfer.tooltip.bind.1", Component.translatable(context.getLevel().getBlockState(pos).getBlock().getDescriptionId()), pos.toShortString()));
