...
public class MachineLang {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("gtmoremachine.machine.huge_item_bus.import.tooltip", "Inputs items for multiblock structures, with each slot able to store up to 2^31-1 items.");
        provider.add("gtmoremachine.machine.huge_item_bus.export.tooltip", "Outputs items for multiblock structures, with each slot able to store up to 2^31-1 items.");
        ...
        provider.add("gui.gtmoremachine.share_inventory.desc.1", "In the catalyst slot, only non-consumable items can participate in the synthesis.");
        provider.add("gui.gtmoremachine.share_inventory.desc.2", "Common items can be automatically input by placing a container in front of the input bus.");
        ...
        provider.add("gtmoremachine.machine.wireless_energy_cover.tooltip.3", "The Wireless Energy Reciver bind to unknow user: %s");
        ...
        provider.add("gtmoremachine.machine.energy_hatch.target.tooltip", "Large Amount Of Energy Input for Multiblocks");
        provider.add("gtmoremachine.machine.energy_hatch.source.tooltip", "Large Amount Of Energy Output for Multiblocks");
        provider.add("gtmoremachine.machine.wireless_energy_hatch.input.tooltip", "You can bind or change the owner by left-click the Energy Hatch with Data Stick,or right-click to unbind.");
        provider.add("gtmoremachine.machine.wireless_energy_hatch.output.tooltip", "You can bind or change the owner by left-click the Dynoma Hatch with Data Stick,or right-click to unbind.");
        provider.add("gtmoremachine.machine.wireless_energy_hatch.target.tooltip", "You can bind or change the owner by left-click the Laser Target Hatch with Data Stick,or right-click to unbind.");
        provider.add("gtmoremachine.machine.wireless_energy_hatch.source.tooltip", "You can bind or change the owner by left-click the Laser Source Hatch with Data Stick,or right-click to unbind.");
        provider.add("gtmoremachine.machine.wireless_computation_transmitter_hatch.tooltip.1", "Output computational power data from the multiblock structure.");
        provider.add("gtmoremachine.machine.wireless_computation_transmitter_hatch.tooltip.2", "Need to bind the wireless computational power target Hatch and the wireless computational power source Hatch by right-clicking with a flash memory.");
        provider.add("gtmoremachine.machine.wireless_computation_transmitter_hatch.tobind", "Source Hatch data reading completed, please right-click the target Hatch to bind.");
        provider.add("gtmoremachine.machine.wireless_computation_receiver_hatch.tooltip.1", "Input computational power data for the multiblock structure.");
        provider.add("gtmoremachine.machine.wireless_computation_receiver_hatch.tooltip.2", "gtmoremachine.machine.wireless_computation_receiver_hatch.tooltip.2");
        provider.add("gtmoremachine.machine.wireless_computation_receiver_hatch.tobind", "Target Hatch data reading completed, please right-click the source Hatch to bind.");
        provider.add("gtmoremachine.machine.wireless_computation_hatch.binded", "Wireless computational power data Hatch binding completed.");
