...
public class AssemblerRecipe {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        if (GTmm.Mods.isAE2Loaded()) {
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("programmable_cover"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("virtual_item_provider"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("virtual_item_provider_cell"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("me_export_buffer"))
            ...
            if (GTCEuAPI.isHighTier()) {
                ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("programmablec_hatch_" + GTValues.VN[GTValues.MAX].toLowerCase() + "_4a"))
                ...
                ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("programmablec_dualhatch_" + GTValues.VN[GTValues.MAX].toLowerCase() + "_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_monitor"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_lv"))
                .inputItems(GTItems.SENSOR_LV.asStack())
                .inputItems(GTItems.EMITTER_LV.asStack())
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_lv_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_mv"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_mv_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_hv"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_hv_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_ev"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_ev_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_iv"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_iv_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_luv"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_luv_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_zpm"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_zpm_4a"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_uv"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_receive_cover_uv_4a"))
        ...
        for (int tier : GTValues.tiersBetween(GTValues.LV, GTCEuAPI.isHighTier() ? GTValues.OpV : GTValues.UV)) {
            if (tier > GTValues.IV && GTmm.Mods.isAE2Loaded()) {
                ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("programmablec_hatch_" + GTValues.VN[tier].toLowerCase() + "_4a"))
                ...
                ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("programmablec_dualhatch_" + GTValues.VN[tier].toLowerCase() + "_4a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_input_hatch_" + GTValues.VN[tier].toLowerCase()))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_output_hatch_" + GTValues.VN[tier].toLowerCase()))
        ...
        for (int tier : GTValues.tiersBetween(GTValues.EV, GTCEuAPI.isHighTier() ? GTValues.OpV : GTValues.UV)) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_input_hatch_" + GTValues.VN[tier].toLowerCase() + "_4a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_input_hatch_" + GTValues.VN[tier].toLowerCase() + "_16a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_output_hatch_" + GTValues.VN[tier].toLowerCase() + "_4a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_output_hatch_" + GTValues.VN[tier].toLowerCase() + "_16a"))
        ...
        for (int tier : GTValues.tiersBetween(GTValues.IV, GTCEuAPI.isHighTier() ? GTValues.OpV : GTValues.UV)) {
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_input_hatch_" + GTValues.VN[tier].toLowerCase() + "_256a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_input_hatch_" + GTValues.VN[tier].toLowerCase() + "_1024a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_input_hatch_" + GTValues.VN[tier].toLowerCase() + "_4096a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_output_hatch_" + GTValues.VN[tier].toLowerCase() + "_256a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_output_hatch_" + GTValues.VN[tier].toLowerCase() + "_1024a"))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_energy_output_hatch_" + GTValues.VN[tier].toLowerCase() + "_4096a"))
        ...
        for (int tier : GTValues.tiersBetween(GTValues.LV, GTCEuAPI.isHighTier() ? GTValues.OpV : GTValues.UV)) {
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("huge_item_import_bus_" + GTValues.VN[tier].toLowerCase()))
                    ...
                    .EUt(GTValues.VA[tier])
                    .save(provider);
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("huge_item_export_bus_" + GTValues.VN[tier].toLowerCase()))
        ...
        for (int tier : GTValues.tiersBetween(GTValues.LV, GTCEuAPI.isHighTier() ? GTValues.OpV : GTValues.UV)) {
            ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("huge_dual_hatch_" + GTValues.VN[tier].toLowerCase()))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_computation_transmitter_hatch"))
        ...
        ASSEMBLER_RECIPES.recipeBuilder(GTmm.id("wireless_computation_receiver_hatch"))
                .inputItems(GTResearchMachines.COMPUTATION_HATCH_TRANSMITTER.asStack())
                .inputItems(CustomTags.ZPM_CIRCUITS)
