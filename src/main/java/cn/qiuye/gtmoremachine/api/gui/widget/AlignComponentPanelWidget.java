...
public class AlignComponentPanelWidget extends Widget {
    ...
    public AlignComponentPanelWidget(int x, int y, Consumer<List<Component>> textSupplier) {
        super(x, y, 0, 0);
    ...
    public void formatDisplayText() {
        ...
        this.cacheLines = this.lastText.stream().flatMap((component) -> FormattingUtil.formatJustifyComponent(component, maxTextWidthResult, fontRenderer, this.splitChar).stream()).toList();
    }
