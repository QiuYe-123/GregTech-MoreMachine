package cn.qiuye.gtmoremachine.api.machine.fancyconfigurator;
...
public class InventoryFancyConfigurator implements IFancyConfigurator {
    ...
    public IGuiTexture getIcon() {
        return new ResourceTexture("%s:textures/overlay/inventory_configurator.png".formatted(GTmm.MOD_ID));
    }
