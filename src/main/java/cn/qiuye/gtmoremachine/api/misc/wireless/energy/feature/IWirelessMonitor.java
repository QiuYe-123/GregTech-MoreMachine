...
public interface IWirelessMonitor extends IWirelessEnergyContainerHolder {
    ...
    default List<Component> getDisplayText(Statistics statistics, Format format, Status powerStatus, Sorting sorting, Type type) {
        ...
        textListCache.add(FormattingUtil.formatWithConstantWidth(WirelessMachines.WIRELESS_ENERGY_MONITOR_TOOLTIP_1,
        ...
        if (GTMMConfig.INSTANCE.isWirelessRateEnable) {
            ...
            textListCache.add(FormattingUtil.formatWithConstantWidth(WirelessMachines.WIRELESS_ENERGY_MONITOR_TOOLTIP_2,
        ...
        textListCache.add(Component.translatable(WirelessMachines.WIRELESS_MONITOR_TOOLTIP_NET_POWER,
                getPowerStatusText(powerStatus)));

        BigDecimal avgMinute = stat.getMinuteAvg(powerStatus);
        textListCache.add(FormattingUtil.formatWithConstantWidth(WirelessMachines.WIRELESS_ENERGY_MONITOR_TOOLTIP_LAST_MINUTE,
        ...
        textListCache.add(FormattingUtil.formatWithConstantWidth(WirelessMachines.WIRELESS_ENERGY_MONITOR_TOOLTIP_LAST_HOUR,
        ...
        textListCache.add(FormattingUtil.formatWithConstantWidth(WirelessMachines.WIRELESS_ENERGY_MONITOR_TOOLTIP_LAST_DAY,
        ...
        textListCache.add(FormattingUtil.formatWithConstantWidth(WirelessMachines.WIRELESS_ENERGY_MONITOR_TOOLTIP_NOW,
        ...
        if (compare > 0) {
            textListCache.add(Component.translatable("gtceu.multiblock.power_substation.time_to_fill",
                    GTMMConfig.INSTANCE.isWirelessCapacitylimitEnable ?
                            ...
                            Component.translatable(WirelessMachines.WIRELESS_ENERGY_MONITOR_TOOLTIP_TIME_TO_FILL))
        ...
        if (GTMMConfig.INSTANCE.isWirelessRateEnable && container.getBindPos() != null) {
            ...
            textListCache.add(Component.translatable(WirelessMachines.WIRELESS_ENERGY_HATCH_TOOLTIP_2,
        ...
        textListCache.add(Component.translatable(WirelessMachines.WIRELESS_MONITOR_TOOLTIP_STATISTICS_ENERGY,
